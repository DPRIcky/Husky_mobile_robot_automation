...
def generate_launch_description():
        ...
        launch_arguments=
            [
                (
                    'setup_path'
                    ,
                    '/home/prajjwal/clearpath/robot2'
                )
                ,
                (
                    'use_sim_time'
    ...
    node_cmd_vel_bridge = Node(
        ...
        arguments=
            [
                'a300_00001/cmd_vel@geometry_msgs/msg/TwistStamped[gz.msgs.Twist'
                ,
                '/model/a300_00001/robot/cmd_vel@geometry_msgs/msg/TwistStamped]gz.msgs.Twist'
                ,
            ]
        ,
        remappings=
            [
                ...
                ,
                (
                    '/model/a300_00001/robot/cmd_vel'
                    ,
                    'platform/cmd_vel'
                )
                ,
    ...
    node_odom_base_tf_bridge = Node(
        ...
        arguments=
            [
                '/model/a300_00001/robot/tf@tf2_msgs/msg/TFMessage[gz.msgs.Pose_V'
                ,
            ]
        ,
        remappings=
